...
const vrWorldSetup: ToolDefinition = { id: "vrc_world_setup", name: "Setup VRChat World", description: "Add VRC_SceneDescriptor and configure world settings", descriptionJa: "VRC_SceneDescriptorを追加してワールド設定を行う", category: "vrchat",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "VrcWorldSetup", params); return { success: true, message: "VRChat world configured", data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const vrAvatarSetup: ToolDefinition = { id: "vrc_avatar_setup", name: "Setup VRChat Avatar", description: "Add VRC_AvatarDescriptor and configure viewpoint", descriptionJa: "VRC_AvatarDescriptorを追加してビューポイントを設定する", category: "vrchat",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "VrcAvatarSetup", params); return { success: true, message: `Avatar configured: ${params.name}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const vrTrigger: ToolDefinition = { id: "vrc_trigger", name: "Add VRChat Trigger", description: "Add an Udon trigger zone to a GameObject", descriptionJa: "GameObjectにUdonトリガーゾーンを追加する", category: "vrchat",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "VrcTrigger", params); return { success: true, message: `Trigger added: ${params.event}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const vrMirror: ToolDefinition = { id: "vrc_mirror", name: "Add VRChat Mirror", description: "Create a VRC mirror in the scene", descriptionJa: "シーンにVRCミラーを作成する", category: "vrchat",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "VrcMirror", params); return { success: true, message: `Mirror created: ${params.name}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const vrPickup: ToolDefinition = { id: "vrc_pickup", name: "Add VRChat Pickup", description: "Make a GameObject pickupable in VRChat", descriptionJa: "GameObjectをVRChatで持てるようにする", category: "vrchat",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "VrcPickup", params); return { success: true, message: `Pickup added to ${params.name}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const vrSync: ToolDefinition = { id: "vrc_sync", name: "Add Object Sync", description: "Add VRC ObjectSync for network synchronization", descriptionJa: "ネットワーク同期用のVRC ObjectSyncを追加する", category: "vrchat",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "VrcSync", params); return { success: true, message: `ObjectSync added to ${params.name}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const vrTeleport: ToolDefinition = { id: "vrc_teleport", name: "Add Teleport Point", description: "Create a teleport destination point", descriptionJa: "テレポート先ポイントを作成する", category: "vrchat",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "VrcTeleport", params); return { success: true, message: `Teleport point created: ${params.name}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const vrVideoPlayer: ToolDefinition = { id: "vrc_video_player", name: "Add Video Player", description: "Add a synced VRChat video player", descriptionJa: "同期VRChat動画プレイヤーを追加する", category: "vrchat",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "VrcVideoPlayer", params); return { success: true, message: `Video player created: ${params.name}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const vrChair: ToolDefinition = { id: "vrc_chair", name: "Add VRChat Chair", description: "Add a sittable station/chair", descriptionJa: "座れるステーション/椅子を追加する", category: "vrchat",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "VrcChair", params); return { success: true, message: `Chair created: ${params.name}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const vrLightmap: ToolDefinition = { id: "vrc_lightmap", name: "Bake VRChat Lightmap", description: "Bake lightmaps optimized for VRChat", descriptionJa: "VRChat向けに最適化されたライトマップをベイクする", category: "vrchat",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "VrcLightmap", params); return { success: true, message: `Lightmap baked: ${params.quality}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
