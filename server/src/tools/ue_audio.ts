...
const ueAudioAddComponent: ToolDefinition = {
  ...
  handler: async (p) => { const r = await bridge.send("unreal", "AudioAddComponent", p); return r ? { success: true, message: `Audio added to ${p.actorName}`, data: r } : { success: false, message: "Failed" }; }
};
...
const ueAudioSetVolume: ToolDefinition = {
  ...
  handler: async (p) => { const r = await bridge.send("unreal", "AudioSetVolume", p); return r ? { success: true, message: `Volume set to ${p.volume}`, data: r } : { success: false, message: "Failed" }; }
};
...
const ueAudioSetPitch: ToolDefinition = {
  ...
  handler: async (p) => { const r = await bridge.send("unreal", "AudioSetPitch", p); return r ? { success: true, message: `Pitch set to ${p.pitch}`, data: r } : { success: false, message: "Failed" }; }
};
...
const ueAudioSetSpatial: ToolDefinition = {
  ...
  handler: async (p) => { const r = await bridge.send("unreal", "AudioSetSpatial", p); return r ? { success: true, message: `Spatialization set on ${p.actorName}`, data: r } : { success: false, message: "Failed" }; }
};
...
const ueAudioAddAmbientSound: ToolDefinition = {
  ...
  handler: async (p) => { const r = await bridge.send("unreal", "AudioAddAmbient", p); return r ? { success: true, message: "Ambient sound added", data: r } : { success: false, message: "Failed" }; }
};
...
const ueAudioAddReverb: ToolDefinition = {
  ...
  handler: async (p) => { const r = await bridge.send("unreal", "AudioAddReverb", p); return r ? { success: true, message: `Reverb added: ${p.preset}`, data: r } : { success: false, message: "Failed" }; }
};
