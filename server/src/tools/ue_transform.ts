...
const ueTransformSetLocation: ToolDefinition = {
  ...
  handler: async (p) => {
    const r = await unrealBridge.send("TransformSetLocation", p);
...
const ueTransformSetRotation: ToolDefinition = {
  ...
  handler: async (p) => {
    const r = await unrealBridge.send("TransformSetRotation", p);
...
const ueTransformSetScale: ToolDefinition = {
  ...
  handler: async (p) => {
    const r = await unrealBridge.send("TransformSetScale", p);
...
const ueTransformAttach: ToolDefinition = {
  ...
  handler: async (p) => {
    const r = await unrealBridge.send("TransformAttach", p);
...
const ueTransformDetach: ToolDefinition = {
  ...
  handler: async (p) => {
    const r = await unrealBridge.send("TransformDetach", p);
...
const ueTransformSnapToGrid: ToolDefinition = {
  ...
  handler: async (p) => {
    const r = await unrealBridge.send("TransformSnapToGrid", p);
