...
export const probuilderTools: ToolDefinition[] = [
  {
    ...
    handler: async (params) => {
      const result = await unityBridge.send("ProBuilderCreateShape", params);
  ...
  },
  {
    ...
    handler: async (params) => {
      const result = await unityBridge.send("ProBuilderExtrudeFaces", params);
  ...
  },
  {
    ...
    handler: async (params) => {
      const result = await unityBridge.send("ProBuilderSubdivide", params);
  ...
  },
  {
    ...
    handler: async (params) => {
      const result = await unityBridge.send("ProBuilderMergeObjects", params);
  ...
  },
  {
    ...
    handler: async (params) => {
      const result = await unityBridge.send("ProBuilderBooleanOperation", params);
  ...
  },
  {
    ...
    handler: async (params) => {
      const result = await unityBridge.send("ProBuilderSetMaterialPerFace", params);
  ...
  },
  {
    ...
    handler: async (params) => {
      const result = await unityBridge.send("ProBuilderGenerateUV", params);
  ...
  },
  {
    ...
    handler: async (params) => {
      const result = await unityBridge.send("ProBuilderExportMesh", params);
