...
const inputCreateAction: ToolDefinition = {
  ...
  handler: async (params) => { try { const r = await unityBridge.send("InputCreateAction", params); return { success: true, message: `Input Action created: ${params.name}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } }
};
...
const inputAddBinding: ToolDefinition = {
  ...
  handler: async (params) => { try { const r = await unityBridge.send("InputAddBinding", params); return { success: true, message: `Binding added: ${params.bindingPath}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } }
};
...
const inputEnable: ToolDefinition = {
  ...
  handler: async (params) => { try { const r = await unityBridge.send("InputEnable", params); return { success: true, message: `Input ${params.enabled ? "enabled" : "disabled"} on ${params.objectName}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } }
};
...
const inputCreateMap: ToolDefinition = {
  ...
  handler: async (params) => { try { const r = await unityBridge.send("InputCreateMap", params); return { success: true, message: `Action Map created: ${params.mapName}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } }
};
...
const inputReadValue: ToolDefinition = {
  ...
  handler: async (params) => { try { const r = await unityBridge.send("InputReadValue", params); return { success: true, message: `Value read from ${params.actionName}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } }
};
...
const inputRemoveBinding: ToolDefinition = {
  ...
  handler: async (params) => { try { const r = await unityBridge.send("InputRemoveBinding", params); return { success: true, message: `Binding removed from ${params.actionName}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } }
};
