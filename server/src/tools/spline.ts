...
const splineCreate: ToolDefinition = {
  ...
  handler: async (p) => {
    const r = await unityBridge.send("SplineCreate", p);
...
const splineAddKnot: ToolDefinition = {
  ...
  handler: async (p) => {
    const r = await unityBridge.send("SplineAddKnot", p);
...
const splineRemoveKnot: ToolDefinition = {
  ...
  handler: async (p) => {
    const r = await unityBridge.send("SplineRemoveKnot", p);
...
const splineSetTangent: ToolDefinition = {
  ...
  handler: async (p) => {
    const r = await unityBridge.send("SplineSetTangent", p);
...
const splineAnimate: ToolDefinition = {
  ...
  handler: async (p) => {
    const r = await unityBridge.send("SplineAnimate", p);
...
const splineExtrude: ToolDefinition = {
  ...
  handler: async (p) => {
    const r = await unityBridge.send("SplineExtrude", p);
...
const splineEvaluate: ToolDefinition = {
  ...
  handler: async (p) => {
    const r = await unityBridge.send("SplineEvaluate", p);
...
const splineGetLength: ToolDefinition = {
  ...
  handler: async (p) => {
    const r = await unityBridge.send("SplineGetLength", p);
