...
const ueBpCreate: ToolDefinition = {
  ...
  handler: async (p) => { const r = await unrealBridge.send("BpCreate", p); return r ? { success: true, message: `Blueprint created: ${p.name}`, data: r } : { success: false, message: "Failed" }; }
};
...
const ueBpAddComponent: ToolDefinition = {
  ...
  handler: async (p) => { const r = await unrealBridge.send("BpAddComponent", p); return r ? { success: true, message: `Component ${p.componentType} added`, data: r } : { success: false, message: "Failed" }; }
};
...
const ueBpAddVariable: ToolDefinition = {
  ...
  handler: async (p) => { const r = await unrealBridge.send("BpAddVariable", p); return r ? { success: true, message: `Variable ${p.varName} added`, data: r } : { success: false, message: "Failed" }; }
};
...
const ueBpAddFunction: ToolDefinition = {
  ...
  handler: async (p) => { const r = await unrealBridge.send("BpAddFunction", p); return r ? { success: true, message: `Function ${p.funcName} added`, data: r } : { success: false, message: "Failed" }; }
};
...
const ueBpAddEvent: ToolDefinition = {
  ...
  handler: async (p) => { const r = await unrealBridge.send("BpAddEvent", p); return r ? { success: true, message: `Event ${p.eventType} added`, data: r } : { success: false, message: "Failed" }; }
};
...
const ueBpAddNode: ToolDefinition = {
  ...
  handler: async (p) => { const r = await unrealBridge.send("BpAddNode", p); return r ? { success: true, message: `Node ${p.nodeType} added`, data: r } : { success: false, message: "Failed" }; }
};
...
const ueBpConnectNodes: ToolDefinition = {
  ...
  handler: async (p) => { const r = await unrealBridge.send("BpConnectNodes", p); return r ? { success: true, message: `Connected ${p.fromNode} -> ${p.toNode}`, data: r } : { success: false, message: "Failed" }; }
};
...
const ueBpCompile: ToolDefinition = {
  ...
  handler: async (p) => { const r = await unrealBridge.send("BpCompile", p); return r ? { success: true, message: `Blueprint compiled: ${p.bpName}`, data: r } : { success: false, message: "Failed" }; }
};
...
const ueBpSpawn: ToolDefinition = {
  ...
  handler: async (p) => { const r = await unrealBridge.send("BpSpawn", p); return r ? { success: true, message: "Blueprint actor spawned", data: r } : { success: false, message: "Failed" }; }
};
...
const ueBpGetInfo: ToolDefinition = {
  ...
  category: "ue_blueprint",
  inputSchema: z.object({ bpName: z.string() }),
  handler: async (p) => { const r = await unrealBridge.send("BpGetInfo", p); return r ? { success: true, message: `Info for ${p.bpName}`, data: r } : { success: false, message: "Failed" }; }
};
