...
const xrSetup: ToolDefinition = { id: "xr_setup", name: "Setup XR Rig", description: "Create and configure an XR Origin rig", descriptionJa: "XR Originリグを作成・設定する", category: "xr",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "XrSetup", params); return { success: true, message: `XR Rig created: ${params.trackingMode}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const xrTracking: ToolDefinition = { id: "xr_tracking", name: "Set Tracking Origin", description: "Set XR tracking origin mode", descriptionJa: "XRトラッキングオリジンモードを設定する", category: "xr",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "XrTracking", params); return { success: true, message: `Tracking origin: ${params.origin}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const xrController: ToolDefinition = { id: "xr_controller", name: "Configure Controller", description: "Configure XR controller input mappings", descriptionJa: "XRコントローラーの入力マッピングを設定する", category: "xr",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "XrController", params); return { success: true, message: `Controller configured: ${params.hand}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const xrHaptics: ToolDefinition = { id: "xr_haptics", name: "Send Haptic Feedback", description: "Send haptic vibration to a controller", descriptionJa: "コントローラーにハプティクス振動を送信する", category: "xr",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "XrHaptics", params); return { success: true, message: `Haptics sent to ${params.hand}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const xrTeleport: ToolDefinition = { id: "xr_teleport", name: "Add Teleport Locomotion", description: "Add teleport locomotion system to XR rig", descriptionJa: "XRリグにテレポート移動システムを追加する", category: "xr",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "XrTeleport", params); return { success: true, message: `Teleport added: ${params.lineType}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const xrGrab: ToolDefinition = { id: "xr_grab", name: "Make Grabbable", description: "Make an object grabbable in XR", descriptionJa: "オブジェクトをXRで掴めるようにする", category: "xr",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "XrGrab", params); return { success: true, message: `${params.name} made grabbable`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const xrRayInteraction: ToolDefinition = { id: "xr_ray_interaction", name: "Add Ray Interactor", description: "Add ray-based interaction to XR controller", descriptionJa: "XRコントローラーにレイベースインタラクションを追加する", category: "xr",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "XrRayInteraction", params); return { success: true, message: `Ray interactor added to ${params.hand}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const xrUI: ToolDefinition = { id: "xr_ui", name: "Create XR UI Canvas", description: "Create a world-space UI canvas for XR interaction", descriptionJa: "XRインタラクション用のワールドスペースUIキャンバスを作成する", category: "xr",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "XrUI", params); return { success: true, message: `XR Canvas created: ${params.name}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const xrPassthrough: ToolDefinition = { id: "xr_passthrough", name: "Enable Passthrough", description: "Enable AR/MR passthrough mode", descriptionJa: "AR/MRパススルーモードを有効化する", category: "xr",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "XrPassthrough", params); return { success: true, message: `Passthrough ${params.enabled ? "enabled" : "disabled"}`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
...
const xrBoundary: ToolDefinition = { id: "xr_boundary", name: "Set Play Boundary", description: "Configure the XR play area boundary", descriptionJa: "XRプレイエリア境界を設定する", category: "xr",
  ...
  handler: async (params) => { try { const r = await bridge.send("unity", "XrBoundary", params); return { success: true, message: `Boundary set: ${params.width}x${params.depth}m`, data: r }; } catch (e: any) { return { success: false, message: e.message }; } } };
