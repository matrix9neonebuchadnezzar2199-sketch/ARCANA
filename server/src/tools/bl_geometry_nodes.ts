...
export const blGeometryNodesTools: ToolDefinition[] = [
  {
    ...
    handler: async (params) => {
      return bridgeSendAsToolResult("blender", "bl_geonodes_create_tree", params, { successMessage: (_, params) => `Geometry Nodes tree created on "${params.objectName}"` });
    },
  },
  {
    ...
    handler: async (params) => {
      return bridgeSendAsToolResult("blender", "bl_geonodes_add_node", params, { successMessage: (_, params) => `Node "${params.nodeType}" added to "${params.treeName}"` });
    },
  },
  {
    ...
    handler: async (params) => {
      return bridgeSendAsToolResult("blender", "bl_geonodes_connect", params, { successMessage: (_, params) => `Connected ${params.fromNode}[${params.fromSocket}] -> ${params.toNode}[${params.toSocket}]` });
    },
  },
  {
    ...
    handler: async (params) => {
      return bridgeSendAsToolResult("blender", "bl_geonodes_set_input", params, { successMessage: (_, params) => `Input "${params.socketName}" set on "${params.nodeName}"` });
    },
  },
  {
    ...
    handler: async (params) => {
      return bridgeSendAsToolResult("blender", "bl_geonodes_add_scatter_setup", params, { successMessage: (_, params) => `Scatter setup created: "${params.instanceObject}" on "${params.objectName}"` });
    },
  },
  {
    ...
    handler: async (params) => {
      return bridgeSendAsToolResult("blender", "bl_geonodes_add_array_setup", params, { successMessage: (_, params) => `Array setup: ${params.count}x "${params.objectName}"` });
    },
  },
  {
    ...
    handler: async (params) => {
      return bridgeSendAsToolResult("blender", "bl_geonodes_add_deform_node", params, { successMessage: (_, params) => `${params.deformType} deformation added to "${params.treeName}"` });
    },
  },
  {
    ...
    handler: async (params) => {
      return bridgeSendAsToolResult("blender", "bl_geonodes_add_group_input", params, { successMessage: (_, params) => `Group input "${params.inputName}" (${params.inputType}) added to "${params.treeName}"` });
    },
  },
  {
    ...
    handler: async (params) => {
      return bridgeSendAsToolResult("blender", "bl_geonodes_add_curve_setup", params, { successMessage: (_, params) => `Curve-to-Mesh setup (${params.curveType}) added to "${params.treeName}"` });
    },
  },
  {
    ...
    handler: async (params) => {
      return bridgeSendAsToolResult("blender", "bl_geonodes_list_tree", params, { successMessage: (_, params) => `Node tree "${params.treeName}" listed` });
    },
  },
];