...
export const blCharacterExportTools: ToolDefinition[] = [
  {
    ...
    handler: async (params) => blenderBridge.send("bl_char_export_vrm", params),
  },
  {
    ...
    handler: async (params) => blenderBridge.send("bl_char_export_fbx", params),
  },
  {
    ...
    handler: async (params) => blenderBridge.send("bl_char_validate_avatar", params),
  },
  {
    ...
    handler: async (params) => blenderBridge.send("bl_char_optimize_avatar", params),
  },
  {
    ...
    handler: async (params) => blenderBridge.send("bl_char_setup_springbone", params),
  },
];