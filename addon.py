...
def _arcana_ensure_skin_material(obj, gender="male"):
    ...
    if mat is None:
        ...
        mat.use_nodes = True
        bsdf = mat.node_tree.nodes.get("Principled BSDF") or mat.node_tree.nodes.get("繝励Μ繝ｳ繧ｷ繝励ΝBSDF")
        if bsdf:
            # Default skin tones
            if gender == "female":
    ...
    if _has_mpfb():
        ...
        if _obj is not None and _obj.get("arcana_backend") == "mpfb2":
            try:
                ...
                _mpfb_hair_base = r"C:/Users/owner/AppData/Roaming/Blender Foundation/Blender/5.1/extensions/.user/blender_org/mpfb/data/hair"
                _mpfb_hair_map = {
    ...
    if _has_mpfb() and obj_check.get("arcana_backend") == "mpfb2":
        ...
        if skin_name:
            try:
                ...
                print(f"[ARCANA] MPFB2 skin asset not available ({skin_name}), using material color")
...
def register_all_handlers():
    ...
    register_not_implemented([
            ...
            # bl_compositor (繝励Λ繧ｰ繧､繝ｳ蛛ｴ縺ｫ蟇ｾ蠢懊↑縺・
            ...
            # bl_geometry_nodes (繝励Λ繧ｰ繧､繝ｳ蛛ｴ縺ｫ蟇ｾ蠢懊↑縺・
            ...
            # bl_armature (繝励Λ繧ｰ繧､繝ｳ蛛ｴ縺ｮID縺ｨ荳堺ｸ閾ｴ)
