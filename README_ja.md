...
[![57 Tools](https://img.shields.io/badge/Tools-202-blue.svg)]()
...
202ツールすべてをAIコンテキストに登録する代わりに、SuperSaveは4つのメタツールのみを公開します：
...
| フェーズ | 状況 | 内容 |
|---------|------|------|
| 1 | 完了 | コアサーバー、SuperSave、Unity 202ツール |
| 2 | 完了 | Navigation、PostProcessing、Script、VRChat、Cinemachine、ProBuilder、Debug、Profiler |
